...
@app.get("/notes")
async def read_notes(skip: int = 0, limit: int = Query(default=10, le=100, ge=10, description="The limit of notes")):
...
# unique case "/note/new" should be used before a common ones (e.g. /notes/{note_id})
@app.get("/note/new")
...
if __name__ == "__main__":
    ...
    # or run the command: fastapi dev[run] main.py
